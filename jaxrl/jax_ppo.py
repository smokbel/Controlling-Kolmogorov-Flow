...
if __name__ == "__main__":
    ...
    # rollout = rollout(env,loaded_params,env_params, 5)
    # jnp.save("rollout_clipped", rollout["trajectories"])
    
    # jnp.save("testing_ppo_clipped", out["runner_state"][1].env_state.trajectory)
    # jnp.save("init_conds", out["runner_state"][1].env_state.new_init)
